        ...
        child: Form(
          ...
          child: Column(
            children: <Widget>[
              SizedBox(height: 20),
              TextFormField(
                decoration: textInputDecoration.copyWith(hintText: 'อีเมล'),
              ...
              SizedBox(height: 20),
              TextFormField(
                decoration: textInputDecoration.copyWith(hintText: 'รหัสผ่าน'),
                validator: (value) =>
                    value.length < 6 ? 'รหัสผ่านต้องมากกว่า 6 ตัวอักษร' : null,
                obscureText: true,
                onChanged: (value) {
